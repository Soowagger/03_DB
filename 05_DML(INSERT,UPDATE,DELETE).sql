...
VALUES
    ('901', '장채현', '901230-2345678', 'jang_ch@kh.or.kr',
...
-- (참고) INSERTG 시 VALUES 서브쿼리 사용 가능
CREATE TABLE EMP_01(
    EMP_ID NUMBER,
...
-- * 조건절(WHERE)을 설정하지 않고 UPDATE 구문 실행 시
-- 모든 행의 컬럼 값 변경 *
...
-- * 여러 칼럼을 한번에 수정할 시 콤마(,)로 컬럼을 구분하면 됨.
-- D9 / 총무부 -> D0 / 전략기획팀
UPDATE DEPARTMENT2 
SET 
    DEPT_ID = 'D0', 
    DEPT_TITLE = '전략기획팀' -- WHERE절 직전 컬럼 작성 시 콤마 X
WHERE DEPT_ID = 'D9'
AND DEPT_TITLE = '총무부';
...
UPDATE EMP_M02 SET SALARY = 0; -- MERGE 결과 뚜렷하게 확인하기 위해

...
-- ORA-01400: NULL을 ("KH_SSM"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
INSERT INTO USER_USED_UK
VALUES(1, 'USER01', 'PASS01', '홍길동', '남', '010-1234-5678', 'hong123@kh.or.kr');
-- ORA-00001: 무결성 제약 조건(KH_SSM.USER_ID_U)에 위배됩니다
...
-- ORA-00001: 무결성 제약 조건(KH_SSM.USER_ID_NAME_U)에 위배됩니다
...
-- NOT NULL + UNIQUE 제약조건의 이미 -> 중복되지 않는 값이 필수로 존재해야 함.
...
-- 기본키 중복 오류
-- ORA-00001: 무결성 제약 조건(KH_SSM.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK
VALUES(NULL, 'USER03', 'PASS03', '유관순', '여', '010-5678-1234', 'yoo123@kh.or.kr');
-- 기본키 NULL 이므로 오류
-- ORA-01400: NULL을 ("KH_SSM"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
...
-- ORA-00001: 무결성 제약 조건(KH_SSM.PK_USERNO_USERID)에 위배됩니다
-- 회원번호와 아이디 둘다 중복되었을 때만 제약조건 위배 에러 발생!

INSERT INTO USER_USED_PK2
VALUES(NULL, 'USER01', 'PASS02', '신사임당', '여', '010-1234-5678', 'hong123@kh.or.kr');
-- ORA-01400: NULL을 ("KH_SSM"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다
...
INSERT INTO USER_USED_FK
VALUES(3, 'USER03', 'PASS03', '유관순', '여', '010-9999-1111', 'yoo123@kh.or.kr', 30);

INSERT INTO USER_USED_FK
VALUES(4, 'USER04', 'PASS04', '안중근', '남', '010-7777-7777', 'ahn123@kh.or.kr', NULL);
--> NULL 사용 가능

INSERT INTO USER_USED_FK
VALUES(5, 'USER05', 'PASS05', '윤봉길', '남', '010-1111-2222', 'yoon123@kh.or.kr', 50);
-- ORA-02291: 무결성 제약조건(KH_SSM.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
...
-- ORA-02292: 무결성 제약조건(KH_SSM.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다
...
-- 3) ON DELETE CASCADE : 부모키가 삭제되면 자식키도 함께 삭제됨
...
-- ORA-02290: 체크 제약조건(KH_SSM.GENDER_CHECK)이 위배되었습니다
...
CREATE TABLE USER_TEST(
    ...
    STATUS VARCHAR(1) DEFAULT 'N' CONSTRAINT NN_STATUS NOT NULL,
...
VALUES(1, 'USER01', 'PASS01', '123456-1234567', '남', '010-1234-1234', '서울시 동대문구','N');

INSERT INTO USER_TEST
VALUES(2, 'USER02', 'PASS02', '123456-2123456', '여', '010-3434-1234', '서울시 성동구','N');

INSERT INTO USER_TEST
VALUES(3, 'USER03', 'PASS03', '654321-2223456', '여', '010-3434-7676', '서울시 서대문구','N');

INSERT INTO USER_TEST
VALUES(4, 'USER04', 'PASS04', '123789-1113456', '남', '010-3434-9999', '서울시 강남구','N');

INSERT INTO USER_TEST
VALUES(5, 'USER05', 'PASS05', '155556-1145456', '남', '010-8888-1234', '서울시 중구', 'Y');
...
--> 참조 테이블의 PK(기본키)를 FK로 사용하는 경우 참조 컬럼명 생략 가능

-- ALTER TABLE 테이블명 MODIFY 컬럼명 NOT NULL;

-- NOT NULL 제약조건만 복사된 EMPLOYEE_COPY 테이블에
-- EMP_ID 컬럼에 PK 제약조건 추가
...
-- DEPARTMENT 테이블의 LOCATTION_ID에 외래키 제약조건 추가

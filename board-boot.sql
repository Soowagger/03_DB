...
CREATE USER spring_ssm IDENTIFIED BY spring1234;

GRANT CONNECT, RESOURCE TO spring_ssm;

ALTER USER spring_ssm DEFAULT TABLESPACE SYSTEM QUOTA UNLIMITED ON SYSTEM;
...
UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$mgtPFqZcmxckFQ9cfX5OGOvvV34vgnyZIWXVLzZAzAMU46FZ1Viky' 
WHERE MEMBER_NO = 1;
